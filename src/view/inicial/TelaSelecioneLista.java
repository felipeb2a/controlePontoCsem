...
import view.TelaImportExcelManualSubtrairHoras;
...
public class TelaSelecioneLista extends javax.swing.JFrame {
    ...
    private String nameDb = "csem_controle_de_ponto";;
    ...
    public void EntrarImportManual() {
        try {
            //TELA
...
//            tela.ObterLogin(obterLogin);
    ...
    public void EntrarImportManual2() {
       try {
            //TELA
            TelaImportExcelManualSubtrairHoras tela = new TelaImportExcelManualSubtrairHoras();
            this.setVisible(false);
//            tela.ObterLogin(obterLogin);
            tela.nameDb(nameDb);
            tela.mostrarTela(mostrarTela);
    ...
    private void initComponents() {
        ...
        jButton1.setText("LISTA MANUAL 2");
